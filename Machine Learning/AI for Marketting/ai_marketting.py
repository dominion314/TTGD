...
##Master Link - https://colab.research.google.com/drive/1rxy-O-KvLGDjE5aLNuSshgcWyjHtZRzI?usp=sharing
...
Original file is located at
    https://colab.research.google.com/drive/1rxy-O-KvLGDjE5aLNuSshgcWyjHtZRzI
...
sales_df = pd.read_csv('/content/drive/My Drive/Colab Notebooks/Modern AI Portfolio Builder/Marketing AI/sales_data_sample.csv', encoding = 'unicode_escape')
